...
void SendPacket(int cl, void *packet)
{
	...
	//int pdirection = reinterpret_cast<unsigned char *>(packet)[2];
...
void Test_Thread()
{
	while (true) {
		...
		for (int i = 0; i < num_connections; ++i) {
			...
			switch (rand() % 4 +1) {
			case 1: my_packet.direction = KEY_UP; break;
			case 2: my_packet.direction = KEY_DOWN; break;
			case 3: my_packet.direction = KEY_LEFT; break;
			case 4: my_packet.direction = KEY_RIGHT; break;
			}
